...
【temperament_value の基準】
- 「少しかかった」「若干行きたがった」→ 0.5
- 「かなりかかった」「折り合いを大きく欠いた」→ 1.0
- 「ずっとかかり通し」「制御不能」「投資値なし」→ 1.5
- 言及なし: 0.0

【weight_effect_value の基準】
- 「少し太め」「載及ばない」(+6kg〜+10kg目安) → 0.3
- 「太め残り」「明らかに負荷」(+10kg〜+20kg目安) → 0.5〜1.0
- 「大幅増量で行く手なかった」(+20kg超) → 1.5
- 「絞れていた」「身が載った」（減量がよい方向に働いた）→ -0.3
- 言及なし: 0.0
